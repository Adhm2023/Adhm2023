                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @ALAPATH\
                                  \n\n--------بـدء تتبـع سجـل العابث ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع العابث ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪--------"
                        ...
                        link = "[𐇮 ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪  𐇮](https://t.me/ALAPATH)"
                        text = (
                            "**✘ تقـريـر اشعـار عابث ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار عابث ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪 ✘**\n\n "
                        link = "[𐇮  ⏐𓆩𓅃𝘼𝙇𝘼𝙋𝘼𝙏𝙃𓃠𓆪 𐇮](https://t.me/ALAPATH)"
